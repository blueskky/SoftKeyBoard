    ...
    var r = function (c, j) {
        ...
        return {
                        ...
                        children: [{
                            ...
                            children: [{
                                ...
                                children: [{
                                    ...
                                    validate: function () {
                                        var a = this.getValue().match(v); if (a) { var width = parseFloat(a[1], 10); if (width > 700) { alert("图像最大宽度为700"); return false; } if (width <= 0) { alert("图像最小宽度为1"); return false; } } (a = !!(a && 0 !== parseInt(a[1], 10))) || alert(c.lang.common.invalidWidth);
                                        return a
                                    },
                                    setup: y,
                                ...
                                },
                                {
                                    ...
                                    validate: function () {
                                        var a = this.getValue().match(v); if (a) { var height = parseInt(a[1], 10); if (height > 2048) { alert("图像最大高度为2048"); return false; } if (height <= 0) { alert("图像最小高度为1"); return false; } }; (a = !!(a && 0 !== parseInt(a[1], 10))) || alert(c.lang.common.invalidHeight);
                                        return a
                                    },
                                    setup: y,
                                    commit: function (a, b, d) {
            ...
            },
            {
                ...
                {
                    type: "html",
                    html: "<p>2.图片名显示在对话框中，请点击下方\"上传图片\"按钮来上传图片</p>"
                },
                {
                    type: "fileButton",
                    id: "uploadButton",
